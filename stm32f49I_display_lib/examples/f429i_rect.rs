...
// STM32F429I-DISC hardware rectangle render using 8-bit parallel GC9A01A interface.
...
#[cfg(feature = "hw-ili9341")]
use stm32f49I_display_lib::{draw_rectangle_outline, Rgb565};
...
fn main() -> ! {
    ...
    // Draw a rectangle outline using our library API
    let rect = stm32f49I_display_lib::Rect { x: 20, y: 30, width: 180, height: 120 };
    let color = Rgb565::from_rgb888(255, 0, 0);
    draw_rectangle_outline(&mut lcd, rect, color, 4).unwrap();
